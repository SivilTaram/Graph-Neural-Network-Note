...
相信熟悉 RNN/LSTM/GRU 等循环神经网络的同学看到这里会有一点小困惑，因为图神经网络不论是前向传播的方式，还是反向传播的优化算法，与循环神经网络都有点相像。这并不是你的错觉，实际上，图神经网络确实可以对应到序列模型中的循环神经网络。为了清楚地揭示他们之间的不同，我们下面用一张图片来解释这两者设计哲学上的不同：

![GNN与RNN的区别](https://raw.githubusercontent.com/SivilTaram/Graph-Neural-Network-Note/master/images/image-5-gnn-rnn.png)

假设在GNN中存在三个结点$x_1$,$x_2$,$x_3$，相应地，在RNN中有一个序列$(x_1,x_2,x_3)$。
